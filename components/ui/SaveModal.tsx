...
export const SaveModal = ({ isOpen, onClose, onSave, title, type, isSaving }: SaveModalProps) => {
    ...
    return (
        <div className="fixed inset-0 bg-[#354763]/40 backdrop-blur-sm flex items-center justify-center p-4 z-[100] animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl border border-white/20 overflow-hidden transform animate-in zoom-in-95 duration-200">
                {/* Header */}
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-5">
                    <div className="space-y-1.5">
                        ...
                        <input
                            autoFocus
                            required
                            className="w-full bg-white border-2 border-transparent focus:border-[#354763] outline-none p-3.5 rounded-xl shadow-sm transition-all text-[#354763] font-medium"
                    ...
                    {isProduct && (
                        <>
                            <div className="space-y-1.5">
                                ...
                                <input
                                    className="w-full bg-white border-2 border-transparent focus:border-[#354763] outline-none p-3.5 rounded-xl shadow-sm transition-all text-[#354763] font-mono text-sm"
                            ...
                            <div className="space-y-1.5">
                                ...
                                <textarea
                                    className="w-full bg-white border-2 border-transparent focus:border-[#354763] outline-none p-3.5 rounded-xl shadow-sm transition-all text-[#354763] min-h-[80px] resize-none"
                    ...
                    <div className="bg-[#354763]/5 p-4 rounded-xl flex gap-3 items-start border border-[#354763]/10">
                        <Info size={16} className="text-[#354763] shrink-0 mt-0.5" />
