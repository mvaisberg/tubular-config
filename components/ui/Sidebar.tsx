...
export const Sidebar = () => {
    ...
    return (
        <>
            ...
            <div className="h-[45dvh] md:h-full w-full md:w-[432px] bg-white shadow-[0_-15px_40px_rgba(0,0,0,0.1)] md:shadow-2xl border-t md:border-t-0 border-r-0 md:border-r border-[#354763]/10 flex-shrink-0 z-20 relative flex flex-col">
